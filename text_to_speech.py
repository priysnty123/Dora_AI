...
#Free version for speech recognition 
...
def text_to_speech_with_gtts(input_text, output_filepath):
    ...
    # This code is Scalable for any device i am using my laptop is (acer) windows based.
    try:
        if os_name == "Darwin":  # macOS
            subprocess.run(['afplay', output_filepath])
        elif os_name == "Windows":  # Windows
...
# input_text = "Hi, I am doing fine, how are you? This is a test for AI with Priyanshu"
